...
our %config = (
  ...
  ARFLAGS => [ "r" ],
  CC => "gcc",
  CFLAGS => [ "-Wall -O3", "-g", "-include/home/sri/Thesis/Master-Thesis/SGXDataCenterAttestationPrimitives/QuoteVerification/sgxssl/Linux/../openssl_source/bypass_to_sgxssl.h" ],
  CPPDEFINES => [ "_FORTIFY_SOURCE=2", "GETPID_IS_MEANINGLESS" ],
  CPPFLAGS => [  ],
  CPPINCLUDES => [  ],
  CXX => "g++",
  CXXFLAGS => [ "-Wall -O3", "-g", "-include/home/sri/Thesis/Master-Thesis/SGXDataCenterAttestationPrimitives/QuoteVerification/sgxssl/Linux/../openssl_source/bypass_to_sgxssl.h" ],
  ...
  openssldir => "",
  options => "--config=sgx_config.conf --with-rand-seed=none -g -D_FORTIFY_SOURCE=2 -DGETPID_IS_MEANINGLESS -include/home/sri/Thesis/Master-Thesis/SGXDataCenterAttestationPrimitives/QuoteVerification/sgxssl/Linux/../openssl_source/bypass_to_sgxssl.h --prefix=/home/sri/Thesis/Master-Thesis/SGXDataCenterAttestationPrimitives/QuoteVerification/sgxssl/Linux/../openssl_source/OpenSSL_install_dir_tmp no-afalgeng no-apps no-asan no-bf no-buildtest-c++ no-camellia no-capieng no-cast no-crypto-mdebug no-crypto-mdebug-backtrace no-devcryptoeng no-dso no-dynamic-engine no-ec2m no-ec_nistp_64_gcc_128 no-egd no-external-tests no-fuzz-afl no-fuzz-libfuzzer no-heartbeats no-hw no-idea no-md2 no-md4 no-mdc2 no-msan no-rc4 no-rc5 no-sctp no-shared no-srp no-ssl-trace no-ssl3 no-ssl3-method no-stdio no-tests no-ubsan no-ui-console no-unit-test no-weak-ssl-ciphers no-zlib no-zlib-dynamic",
  perl_archname => "x86_64-linux-gnu-thread-multi",
  perl_cmd => "/usr/bin/perl",
  perl_version => "5.26.1",
  perlargv => [ "--config=sgx_config.conf", "sgx-linux-x86_64", "--with-rand-seed=none", "-g", "no-idea", "no-mdc2", "no-rc5", "no-rc4", "no-bf", "no-ec2m", "no-camellia", "no-cast", "no-srp", "no-hw", "no-dso", "no-shared", "no-ssl3", "no-md2", "no-md4", "no-ui", "no-stdio", "no-afalgeng", "-D_FORTIFY_SOURCE=2", "-DGETPID_IS_MEANINGLESS", "-include/home/sri/Thesis/Master-Thesis/SGXDataCenterAttestationPrimitives/QuoteVerification/sgxssl/Linux/../openssl_source/bypass_to_sgxssl.h", "--prefix=/home/sri/Thesis/Master-Thesis/SGXDataCenterAttestationPrimitives/QuoteVerification/sgxssl/Linux/../openssl_source/OpenSSL_install_dir_tmp" ],
  perlenv => {
      "AR" => undef,
      "BUILDFILE" => undef,
      "CC" => undef,
  ...
  prefix => "/home/sri/Thesis/Master-Thesis/SGXDataCenterAttestationPrimitives/QuoteVerification/sgxssl/Linux/../openssl_source/OpenSSL_install_dir_tmp",
  processor => "",
